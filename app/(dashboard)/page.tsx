  ...
  return (
    <div className="min-h-screen p-6 text-sm text-gray-800">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
        <div className="bg-white rounded-lg shadow p-4 border border-gray-200 h-48">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
        <div className="bg-white rounded-lg shadow p-4 border border-gray-200">
          ...
          <div className="text-sm">
            <p>MRR <span className="float-right">+42.00</span></p>
            <p>Expans <span className="float-right">+18.00</span></p>
            <p>Churn <span className="float-right">₹ 800</span></p>
          </div>
        </div>

        <div className="bg-white rounded-lg shadow p-4 border border-gray-200">
          <h2 className="text-sm font-semibold mb-2">Projected collection</h2>
          <p className="text-2xl font-bold mb-2">₹ 5,983</p>
          <div className="text-sm space-y-1">
            <div className="flex justify-between">
              <span>Upcoming</span><span>₹ 23.00</span>
            </div>
            <div className="flex justify-between">
              <span>Due today</span><span>₹ 12.00</span>
            </div>
            <div className="flex justify-between font-medium text-red-600">
              <span>Overdue</span><span>₹ 30.00</span>
            </div>
            <div className="flex justify-between">
              <span>Due later</span><span>₹ 21.00</span>
            </div>
          </div>
        </div>
      </section>
