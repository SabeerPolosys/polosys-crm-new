              ...
              <div className="bg-white m-4 p-6 min-h-screen">
                <div className=" mx-auto bg-white shadow-md rounded-md p-6">
                  ...
                  <div className="grid grid-cols-2 gap-y-3 text-sm text-gray-700">
                    ...
                    <div>{editionDetails?.isActive ? <span className="bg-green-100 text-green-400 px-4 py-2 rounded-full">Active</span> : <span className="bg-red-100 text-red-400 px-4 py-2 rounded-full">Inactive</span>}</div>
                  </div>
                </div>
